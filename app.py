...
async def ask_chain(question: str, chain):
    ...
    with assistant:
        ...
        message_placeholder.status(random.choice(LOADING_MESSAGES), store="running")
        documents = []
        async for event in ask_questions(chain, question, session_id="session-id-42"):
